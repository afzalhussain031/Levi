...
**Iris** is a **production-level AI voice assistant** that runs entirely locally on Windows. Unlike cloud-based assistants (Alexa, Google Assistant, Siri), Iris:
...
Iris uses **LangChain** to create an agentic system with:
...
- Example:
  ...
  Iris: [Opens YouTube, plays classical music]
  User: "Next track"
  Iris: [Remembers context, skips to next]
  ```
...
python main.py  # Iris will automatically connect
```
...
```
==================================================
🤖 Iris ASSISTANT - Initializing Core Loop
==================================================
...
🎙️ Iris is now listening...
```

### Demo Scenario 1: Basic Voice Recognition (2 minutes)

**Goal**: Show that Iris understands speech in real-time
...
2. Observe output:
   ```
   👤 You said: "Hello Iris"
   🤖 Iris: "Hi there! I'm ready to help."
   🔊 Speaking...
   ```
...
1. **Web Search**
   ...
   - Iris: "I've opened Google search for Python tutorials"
   ```
...
2. **YouTube Search & Play**
   ...
   - Iris: "Playing jazz music for you"
   ```
...
**Goal**: Show how Iris handles dangerous actions safely
...
1. **First Attempt (Blocked)**
   ...
   Expected:
   Iris: "This will shut down the PC. Do you want me to continue? 
...
1. **Question (No Tools Needed)**
   ...
   Expected:
   Iris: "Machine learning is a branch of artificial intelligence 
...
- Iris can listen while speaking
...
1. Creating method in `IrisActionToolkit` class
...
- Explanations for what Iris is doing
